...
<head>
    ...
    <!--! BEGIN: Favicon-->
    <link rel="shortcut icon" type="image/x-icon" href="{{ url('admin/assets/images/favicon.png') }}">
    <!--! END: Favicon-->
    <!--! BEGIN: Bootstrap CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('admin/assets/vendors/css/tagify.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('admin/assets/vendors/css/tagify-data.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('admin/assets/vendors/css/quill.min.css') }}">
    ...
    <!--! END: Vendors CSS-->
    <!--! BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{ url('admin/assets/css/theme.min.css') }}">
    <!--! END: Custom CSS-->
  ...
  <![endif]-->
    ...
    <script src="{{ url('admin/assets/js/sweetalert-init.min.js') }}"></script>
...
<body>
    ...
    <script src="{{ url('admin/assets/vendors/js/circle-progress.min.js') }}"></script>
    ...
    <script src="{{ url('admin/assets/vendors/js/tagify.min.js') }}"></script>
    <script src="{{ url('admin/assets/vendors/js/tagify-data.min.js') }}"></script>
    <script src="{{ url('admin/assets/vendors/js/quill.min.js') }}"></script>
    ...
    <!--! END: Vendors JS !-->
    <!--! BEGIN: Apps Init  !-->
    <script src="{{ url('admin/assets/js/common-init.min.js') }}"></script>
    <script src="{{ url('admin/assets/js/leads-init.min.js') }}"></script>
    <script src="{{ url('admin/assets/js/proposal-init.min.js') }}"></script>
    <!--! END: Apps Init !-->
    <!--! BEGIN: Theme Customizer  !-->
    <script src="{{ url('admin/assets/js/theme-customizer-init.min.js') }}"></script>
