                ...
                <div class="uc-navbar items-center text-gray-900 dark:text-white"
                    ...
                    <div class="uc-navbar-left gap-2 lg:gap-4">
                        ...
                        <div class="uc-logo text-white">
                            <a href="/">
                                <img class="w-80px text-dark dark:text-white"
                                    src="{{ url('site/assets/images/demo-eight/common/radar.png') }}" alt="News5"
                                    data-uc-svg>
                            </a>
                        </div>
                        <ul class="uc-navbar-nav gap-3 fs-5 fw-bolder ms-2 d-none lg:d-flex"
                            ...
                            <li>
                                <a href="{{ route('site.businessinnovation')}}">Negocios & Inovações{{-- <span data-uc-navbar-parent-icon></span> --}}</a>
