...
<body>
    <div class="converter">
        ...
        <div class="currency-group">
            ...
            <input type="number" class="currency-input" id="usd-input" placeholder="Digite o valor em USD" step="0.01" min="0">
        </div>
        ...
        <div class="currency-group">
            ...
            <input type="number" class="currency-input" id="aoa-input" placeholder="Digite o valor em AOA" step="0.01" min="0">
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            const exchangeRate = 830.00; // 1 USD = 830 AOA (aproximado)
